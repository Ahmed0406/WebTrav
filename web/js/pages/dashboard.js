$(function () {
    function t(t, e) {
        ...
        var n = d3.select(t), r = {top: 5, right: 50, bottom: 40, left: 50},
            i = n.node().getBoundingClientRect().width - r.left - r.right, e = e - r.top - r.bottom, s = 30,
            l = n.append("div").attr("class", "d3-tip e").style("display", "none"),
            o = d3.time.format("%m/%d/%y %H:%M"), d = d3.time.format("%H:%M"),
            c = ["#03A9F4", "#29B6F6", "#4FC3F7", "#81D4FA", "#B3E5FC", "#E1F5FE"], u = d3.time.scale().range([0, i]),
            p = d3.scale.linear().range([e, 0]), f = d3.scale.ordinal().range(c),
    ...
    function e(t, e) {
        ...
        var r = d3.select(t), i = {top: 5, right: 30, bottom: 30, left: 50},
            s = r.node().getBoundingClientRect().width - i.left - i.right, e = e - i.top - i.bottom,
            ...
            d = (d3.time.format("%b %d, '%y"), ["#4CAF50", "#FF5722", "#5C6BC0"]), c = d3.scale.ordinal().range(d),
            u = r.append("svg"),
    ...
    function a() {
        d3.csv("assets/demo_data/dashboard/app_sales_heatmap.csv", function (t, e) {
            ...
            var o = d3.time.scale().range([0, width]), d = d3.scale.linear().range([height, 0]),
    ...
    function n(t, e, a) {
        var n = d3.select(t), r = {top: 20, right: 35, bottom: 40, left: 35},
            i = n.node().getBoundingClientRect().width - r.left - r.right, e = e - r.top - r.bottom,
            s = d3.time.format("%Y-%m-%d").parse, l = d3.bisector(function (t) {
                return t.date
            }).left, o = d3.time.format("%b %d"), d = n.append("svg"),
            ...
            u = d3.svg.area().x(function (t) {
                ...
                return f(t.value)
            }).interpolate("monotone"), p = d3.time.scale().range([0, i]), f = d3.scale.linear().range([e, 0]),
        ...
        d3.json("assets/demo_data/dashboard/monthly_sales.json", function (t, m) {
            function g() {
                var t = d3.mouse(this), a = t[0], i = (t[1], p.invert(a)), s = l(m, i), d = m[s - 1], c = m[s],
    ...
    function r(t, e, a) {
        var n = d3.select(t), r = {top: 0, right: 0, bottom: 0, left: 0},
            i = n.node().getBoundingClientRect().width - r.left - r.right, e = e - r.top - r.bottom,
            s = d3.time.format("%Y-%m-%d").parse, l = n.append("svg"),
    ...
    function s(t, e) {
        ...
        var n = [{date: "04/13/14", alpha: "60"}, {date: "04/14/14", alpha: "35"}, {
                ...
                date: "04/18/14",
                alpha: "20"
            }, {date: "04/19/14", alpha: "60"}], r = d3.select(t), i = {top: 0, right: 0, bottom: 0, left: 0},
            s = r.node().getBoundingClientRect().width - i.left - i.right, e = e - i.top - i.bottom, l = 20,
            o = d3.time.format("%m/%d/%y").parse, d = d3.time.format("%a, %B %e"),
    ...
    function l(t, e, a, n) {
        ...
        var i = d3.select(t), s = 2, l = Math.min(e / 2, a / 2) - s, o = 2 * Math.PI, d = $(t).data("progress"),
    ...
    function u(t, e, a, n, r, i, s, l, o) {
        ...
        var h = d3.select(t), m = h.node().getBoundingClientRect().width, g = d3.scale.ordinal().rangeBands([0, m], .3),
            y = d3.scale.linear().range([0, a]);
        g.domain(d3.range(0, p.length)), y.domain([0, d3.max(p)]);
        var v = h.append("svg"), x = v.attr("width", m).attr("height", a).append("g"),
    ...
    function p(t, e, a, n, r, i, s, l) {
        ...
        var d = d3.select(t), c = 0, u = 32, p = r, f = 2 * Math.PI, h = d3.format(".0%"), m = 2 * e,
            g = Math.abs((p - c) / .01), y = p < c ? -.01 : .01, v = d.append("svg"),
    ...
    function f(t, e) {
                ...
                function i(t) {
                    t.each(function (t, e) {
                        ...
                        var i = u.call(this, t, e).slice().sort(d3.descending),
                            ...
                            g = f.call(this, t, e).slice().sort(d3.descending), y = d3.select(this),
        ...
        a();
        var i = d3.select(t), s = {top: 20, right: 10, bottom: 35, left: 10},
            l = l = i.node().getBoundingClientRect().width - s.left - s.right, e = e - s.top - s.bottom,
    ...
    h.forEach(function (t) {
        ...
        var e = $(this).find(".letter-icon-title"), a = e.eq(0).text().charAt(0).toUpperCase(),
